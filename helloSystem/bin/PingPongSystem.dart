...
class PingPongSystem {
  ...
  PingPongSystem() {
    ...
    IsolateRef ping = system.addIsolate("ping", pingUri, pingWorkersPaths, Router.RANDOM, hotDeployment:true);
    IsolateRef pong = system.addIsolate("pong", pongUri, pongWorkersPaths, Router.RANDOM, hotDeployment:true);
